...
class __TwigTemplate_319f3dbccbc4dd925c0221d94a09f829 extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Modifier mes préférences";
    ...
    <div class=\"row justify-content-center\">
        ...
        yield "
                    ...
                    <div class=\"mb-3\">
                        ";
        // line 17
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "city", [], "any", false, false, false, 17), 'row', ["attr" => ["class" => "form-control"]]);
        yield "
                    </div>
                    ...
                    <div class=\"mb-3\">
                        ";
        // line 21
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "newsKeywords", [], "any", false, false, false, 21), 'row', ["attr" => ["class" => "form-control"]]);
        yield "
                        <small class=\"text-muted\">Utilisez des virgules pour séparer les mots (ex: symfony, basket, bitcoin)</small>
                    </div>
        ...
        yield "\" class=\"text-decoration-none\">Retour au Dashboard</a>
                </div>
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  143 => 32,  137 => 29,  131 => 26,  123 => 21,  116 => 17,  110 => 14,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <div class=\"col-md-6\">
            <div class=\"card shadow\">
                ...
                <div class=\"card-body\">
                    ...
                    <div class=\"mb-3\">
                        {{ form_row(form.newsKeywords, {'attr': {'class': 'form-control'}}) }}
                        <small class=\"text-muted\">Utilisez des virgules pour séparer les mots (ex: symfony, basket, bitcoin)</small>
                    </div>
                ...
                <div class=\"card-footer text-center\">
                    <a href=\"{{ path('app_dashboard') }}\" class=\"text-decoration-none\">Retour au Dashboard</a>
                </div>
            </div>
        </div>
    </div>
</div>
{% endblock %}", "dashboard/profile.html.twig", "/var/www/app/templates/dashboard/profile.html.twig");
    }
}
